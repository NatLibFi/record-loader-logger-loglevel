...
(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(
      ...
      require('loglevel'),
      require('@natlibfi/loglevel-message-buffer'),
      require('@natlibfi/loglevel-message-prefix'),
      require('@natlibfi/loglevel-std-streams'),
  ...
  return function(parameters)
  {
    ...
    function create(name)
    {
      ...
      function log(message, message_level)
      {
        ...
        if (auto_flush && logger.hasOwnProperty('flush')) {
          logger.flush();
        }
      ...
      return Object.assign(obj, {
        ...
        flush: function()
        {
          ...
          if (logger.hasOwnProperty('flush')) {
            logger.flush();
          }
          return obj;
        },
